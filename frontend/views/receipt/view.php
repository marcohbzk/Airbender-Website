        ...
        <div class="col m-3 shadow">
            ...
            <div class="row m-5">
                <div class="col-6 m-3">
                    ...
                    <div class="row"><?= $client->user->userData->fName ?> <?= $client->user->userData->surname ?></div>
                    <div class="row"><?= $client->user->email ?></div>
                    <div class="row"><?= $client->user->userData->phone ?></div>
                    <div class="row"><?= $client->user->userData->nif ?></div>
                </div>
            </div>
